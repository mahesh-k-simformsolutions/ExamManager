...
namespace ExamManagementSystem.Migrations
{
    ...
    [Migration("20230510142347_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamManagementSystem.Data.Answer", b =>
                {
                    b.HasOne("ExamManagementSystem.Data.Option", "Option")
                        .WithOne()
                        .HasForeignKey("ExamManagementSystem.Data.Answer", "AnswerId")
            ...
            modelBuilder.Entity("ExamManagementSystem.Data.ExamToStudent", b =>
                {
                    ...
                    b.HasOne("ExamManagementSystem.Data.User", "Student")
                        .WithOne()
                        .HasForeignKey("ExamManagementSystem.Data.ExamToStudent", "StudentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExamManagementSystem.Data.Question", b =>
                {
                    b.HasOne("ExamManagementSystem.Data.Exam", null)
                        .WithMany("Questions")
                        .HasForeignKey("ExamId");
                });
            ...
            modelBuilder.Entity("ExamManagementSystem.Data.ScoreCard", b =>
                {
                    b.HasOne("ExamManagementSystem.Data.Answer", "CorrectAnswer")
                        .WithOne()
                        .HasForeignKey("ExamManagementSystem.Data.ScoreCard", "CorrectAnswerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ExamManagementSystem.Data.Question", "Question")
                        .WithOne()
                        .HasForeignKey("ExamManagementSystem.Data.ScoreCard", "QuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ExamManagementSystem.Data.Answer", "SelectedAnswer")
                        .WithOne()
                        .HasForeignKey("ExamManagementSystem.Data.ScoreCard", "SelectedAnswerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
